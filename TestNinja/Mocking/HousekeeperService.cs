...
namespace TestNinja.Mocking
{
    public class HousekeeperService
    {
        ...
        public void SendStatementEmails(DateTime statementDate)
        {
            ...
            foreach (var housekeeper in housekeepers)
            {
                ...
                try
                {
                    _emailSender.EmailFile(emailAddress, emailBody, statementFilename, $"Sandpiper Statement {statementDate:yyyy-MM} {housekeeper.FullName}");
                }
                catch (Exception e)
                {
    ...
    public class DateForm
    {
        ...
        public DialogResult ShowDialog() => DialogResult.Abort;
    }
